...
# 경로 설정
# =========================
USER_SEGMENT_DIR = os.path.join(BASE_DIR, "user_segments")
...
def extract_all_user_embeddings():
    ...
    np.save(session_path, final_embedding)

    print("\n[COMPLETE]")
    print(f"✔ 처리 개수: {len(embeddings)}")
    print(f"✔ 평균 embedding 저장 완료 → {session_path}")
