...
export default function Web() {
  ...
  const [tab, setTab] = useState<"home" | "my">(
    "home"
  );
  ...
  const uploadAndAnalyze = async () => {
    ...
    try {
      const response = await fetch(
        "http://127.0.0.1:8000/songs/upload",
        {
          method: "POST",
          body: formData,
        }
    ...
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col items-center justify-between px-8 py-12">
      ...
      <div className="flex-1 flex flex-col items-center justify-center w-full">
        ...
        <div className="w-full flex items-center justify-between mb-16">
          ...
          <span
            ...
            style={{
              ...
              color: "#111111",
              fontFamily:
                "'Pretendard Variable', 'SUIT Variable', sans-serif",
            }}
          >
            Sing Pick
          </span>
        ...
        <div className="flex flex-col items-center justify-center flex-1">
          ...
          <img
            ...
            style={{
              filter:
                "drop-shadow(0 25px 50px rgba(47, 124, 49, 0.25))",
            }}
          />
      ...
      <div className="mb-12">
        <button
          ...
          className="w-[220px] bg-gradient-to-br from-[#A8D98B] to-[#5A8E49] text-white py-4 rounded-[20px] shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
    ...
    <div className="min-h-screen bg-[#FAFAFA] pb-24">
      ...
      <header className="bg-white/90 backdrop-blur-xl border-b border-gray-100 sticky top-0 z-40">
        ...
        <div className="max-w-lg mx-auto px-5 py-4 flex items-center justify-between">
          ...
          <h2 className="font-bold tracking-tight text-[15px]">
            Sing Pick
          </h2>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex-1">
                        <h4 className="font-semibold text-[15px] text-gray-900 mb-0.5">
                          {artist.name}
                        </h4>
                      ...
                      <div className="px-2.5 py-1 bg-gradient-to-r from-[#2F7C31]/10 to-[#66BB6A]/10 rounded-full">
                        <span className="text-xs font-bold text-[#2F7C31]">
                          {artist.match}%
                        </span>
                      </div>
