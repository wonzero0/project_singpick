...
# 설정
# =========================
REFERENCE_JSON = "reference_songs.json"
REFERENCE_EMBEDDING_DIR = "embedding_vectors"
...
def load_user_session_embedding():
    ...
    np.save("user_session_embedding.npy", user_session)
    print("[SAVE] user_session_embedding.npy 저장 완료")
